...
<html lang="en">
  <head>
    ...
    <title>BookMyBook-addSubcategory</title>
    <!-- Bootstrap core CSS -->
 ...
 <!-- Display SweetAlert for success message -->
        ...
        <!-- Your form to add subcategory details -->
        <form action="<?= base_url('admin/processAddSubcategory') ?>" method="post">
            <div class="form-group">
                <label for="sub_title">Subcategory Title:</label>
                <input type="text" class="form-control" id="sub_title" name="sub_title" required>
            </div>

            <div class="form-group">
                <label for="number_of_books">Number of Books:</label>
                <input type="number" class="form-control" id="number_of_books" name="number_of_books" required>
            </div>

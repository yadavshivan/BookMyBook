...
<div id="dropdown-container">
    <div class="dropdown-menu-left" id="membership-dropdown" aria-labelledby="userDropdown" style="top: 76px; left: 10px; width:10%; ">
        ...
        <a class="dropdown-item" href="#" onclick="showContent('orders')">Your Orders</a>
...
<div class="hidden" id="membership">
        ...
        <p>Hello Rajababu</p>
        <p>Membership: Family</p>
        <p>Renewal and Next Payment</p>
        <p>Your membership expires on March 10, 2020. You will be notified via email and can renew only after expiry.</p>
...
function saveChanges() {
    ...
    xhr.open('POST', '<?= base_url('loginRegister/updateAccountDetails') ?>', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            if (response.status === 'success') {
                ...
                // Handle errors
                alert('Please edit your account details');
            }
        }
    };
    xhr.send(formData);

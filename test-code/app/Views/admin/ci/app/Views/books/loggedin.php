            ...
            <div class="col-md-3">
                <div class="card <?= $colors[$colorIndex] ?> text-center" style="height: 300px;">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('books/membership_plane') ?>?plan_name=<?= urlencode($plan['plan_name']) ?>&price=<?= $plan['price'] ?>&duration=<?= $plan['duration'] ?>&description=<?= urlencode($plan['description']) ?>">
